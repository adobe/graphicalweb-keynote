...
//private
            ...
            function setupSVG() {
                ...
                Savage(function () {
                    ...
                    //hills
                    el[2] = s.rect(0, 410, 4435, 358).attr({fill: "#c2c2c2", 'class': 'hills2'});
                    ...
                    //terrain
                    el[3] = s.rect(-2, 407, 4437, 360).attr({fill: "#cdcdcd", 'class': 'hills3'});
            ...
            function animateSVGFlat() {
                ...
                for (var i = 0; i < trees.length; i += 1) {
                    trees[i].stop().animate({transform: trees[i].data("from")}, 1e3);
                }
            }
            ...
            function animateSVGCurve() {
                ...
                for (var i = 0; i < trees.length; i += 1) {
                    trees[i].stop().animate({transform: trees[i].data("to")}, 1e3);
                }
            }
