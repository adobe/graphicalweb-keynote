...
define(['text!graphicalweb/views/svg/charSVG.svg', 'graphicalweb/utils/CSS3Helper', 'graphicalweb/views/components/BaseCharacter', 'graphicalweb/models/VarsModel'],
...
//public
            ...
            instance.init = function () {
                $container = $('#charSVG');
                $container.html(svg);
                $dots = d3.selectAll('.svg-dots path');
            };
            ...
            instance.startSpin = function () {
                if (VarsModel.DETAILS === true) {
                    back = d3.select("#svg-body-distort");
                    path1 = back.attr('d');
